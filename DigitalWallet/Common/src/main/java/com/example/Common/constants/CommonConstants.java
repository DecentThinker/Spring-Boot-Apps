...
public class CommonConstants
{
    ...
    public static String BOOTSTRAP_SERVER_IP = "localhost:9092";
    ...
    public static String TXN_DETAILS_TOPIC="TXN_DETAILS_TOPIC";
    public static String TXN_STATUS="TXN_STATUS";
    public static String TXN_STATUS_MESSAGE="TXN_STATUS_MESSAGE";
    public static String TXN_UPDATE_TOPIC="TXN_UPDATE_TOPIC";
}
